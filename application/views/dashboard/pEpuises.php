        ...
        <div class="col-xs-12">
            <div class="box box-danger">
                <div class="box-header">
                    <h3 class="box-title">LISTE D'ARTICLES EPUISES</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="row" style="margin-bottom: 10px">
                        ...
                        <div class="col-md-3 text-right">
                            <form action="<?php echo site_url('admin/finished'); ?>" class="form-inline" method="get">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        ...
                                        if ($q <> '') {
                                            ?>
                                            <a href="<?php echo site_url('admin/finished'); ?>" class="btn btn-default">Reset</a>
                                            <?php
                                        }
                                        ?>
                ...
                <div class="box-footer">
                    <div class="col-md-6">
                        <a href="#" class="btn btn-primary  ">Total : <?php echo $finished_art ?></a>
