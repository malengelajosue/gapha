        ...
        <div class="col-xs-12">
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="row" style="margin-bottom: 10px">
                        ...
                        <div class="col-md-3 text-right">
                            <form action="<?php echo site_url('admin/weak'); ?>" class="form-inline" method="get">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        ...
                                        if ($q <> '') {
                                            ?>
                                            <a href="<?php echo site_url('admin/weak'); ?>" class="btn btn-default">Reset</a>
                                            <?php
                                        }
                                        ?>
                ...
                <div class="box-footer">
                    <div class="col-md-6">
                        <a href="#" class="btn btn-primary  ">Total : <?php echo $weak_art ?></a>
