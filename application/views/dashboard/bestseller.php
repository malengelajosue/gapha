        ...
        <div class="col-xs-12">
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">LISTE DES MEILLEURS VENTES</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    ...
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        foreach ($article_data as $article) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $article->totalVente ?></td>
                                <td><?php echo $article->mois ?></td>
                ...
                <div class="box-footer">
                    <div class="col-md-6">
                        <a href="#" class="btn btn-primary  ">Total : <?php echo $total_vent ?></a>
